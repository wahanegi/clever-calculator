class Quote < ApplicationRecord
  ...
  validates :contract_end_date, comparison: { greater_than: :contract_start_date }
  ...
  def self.ransackable_attributes(_auth_object = nil)
    %w[id customer_id user_id total_price created_at contract_start_date contract_end_date]
  end
