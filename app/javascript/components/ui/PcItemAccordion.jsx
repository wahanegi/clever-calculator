...
export const PcItemAccordion = ({ children, itemName = 'Item name', quotePrice = '0', onToggleNotes, notesIcon }) => {
    ...
    <Accordion flush activeKey={isOpen ? ['0'] : []} bsPrefix={'pc-item-accordion'}>
      <Accordion.Item eventKey="0">
        <div className={'position-relative'}>
          ...
          <div className="pc-extra-actions position-absolute top-50 translate-middle-y d-flex align-items-center gap-2 gap-sm-5 z-1">
