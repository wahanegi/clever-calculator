...
export const DeleteItemModal = ({ show, onHide, onConfirmDelete, nameItem, props }) => {
  ...
  return (
    ...
    >
      ...
      <Modal.Body className={'d-flex flex-column align-items-center justify-content-center p-0'}>
        ...
        <p className={'text-center'}>Do you really want to delete "{nameItem}" from your pricing list?</p>
